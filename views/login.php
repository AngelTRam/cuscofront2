...
<body>
    ...
    <div class="boxf">
        <form class="box" action="index.html" method="post">
            ...
            <a href="./src/app/components/home/home.component.html"  type="submit" name="" value="">Iniciar sesión</a>
            <h2>En caso de no saber su código</h2>
            <h2>de acceso, comunicate con</h2>
            <h2>nosotros</h2>
        </form>
    </div>
